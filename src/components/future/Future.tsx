  ...
  return (
    <div className='Future' id='Futures'>
         ...
         <div className="Future__BottomPart">
              <div className="Future__BottomPart__Image">
                   <img src={image} alt="" />
              </div>
              <div className="Future__BottomPart__Content">
